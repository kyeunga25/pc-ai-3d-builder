...
RigStage 是以香港繁體中文為主的電腦商戶 3D 組裝工作台。現有版本提供受保護的產品目錄、私人素材審核、持久化 PC Builder、可解釋相容性規則及安全 JSON 匯出。
...
- 每個 workspace 可建立及保存最多九個類別的組裝草稿；更新使用樂觀版本及原子 D1 batch。
...
本地開發介面的產品、價格、庫存、素材及 3D 場景均為合成示範資料，不應用作真實報價或工程判斷。Production 介面可在角色及 workspace 限制下讀寫 D1 目錄、審核及組裝資料，並以私人 R2 儲存經驗證的來源圖片及 GLB；版本庫不含任何真實商戶記錄。真實 3D 供應商生成及多模型場景組合尚未啟用。
