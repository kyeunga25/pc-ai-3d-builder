...
- The landing header, hero, synthetic screenshot boundary, trust statements and sign-in boundary are typed bilingual public copy. Their rendered links are limited to same-origin entry/demo roots, in-page sections and tracked local synthetic images; they contain no workspace or protected-record target. Public trust copy describes the boundary but never substitutes for server authorization.
