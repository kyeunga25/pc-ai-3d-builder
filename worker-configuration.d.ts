/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 80c889a2b8cfb90939f190dcd1ff8ce7)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 disallow_importable_env,nodejs_compat
interface __BaseEnv_Env {
	...
	TEAM_DOMAIN: string;
	POLICY_AUD: string;
	ASSET_GENERATION: Workflow<Parameters<import("./src/worker/index").AssetGenerationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GENERATION_MODE" | "GENERATION_MAX_COST_MINOR" | "TEAM_DOMAIN" | "POLICY_AUD">> {}
}
