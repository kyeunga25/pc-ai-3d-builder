...
- exact JSON/CSV media-type token matching, parameter acceptance and prefix-spoof rejection before body reads or database work, plus strict bodyless-operation rejection without consuming or reflecting supplied bytes;
