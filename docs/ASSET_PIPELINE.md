...
- Validate filename/MIME/content agreement in the browser, send only canonical MIME, then independently validate declared content type, file signature and bounded size in the Worker.
