...
The public landing header, hero, primary actions, proof points, synthetic Builder screenshot context, trust boundaries, invited sign-in section and footer present Traditional Chinese above supporting English. Navigation and action names are bilingual, links remain same-origin or local, and the screenshot boundary states that visual material is not compatibility evidence. At 390 px, supporting English, captions and actions wrap without page-level horizontal overflow; reduced-motion preferences continue to suppress entrance animations.
