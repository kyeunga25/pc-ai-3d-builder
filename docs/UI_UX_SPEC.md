...
The workspace member page is visible only to owner/admin roles. It presents invitation guidance, exact Access-policy separation, identity/membership state, role controls and two-step suspension in Traditional Chinese and English. Emails remain inside the protected view, member IDs are never visible, self-management and unauthorized targets have explicit disabled explanations, and the desktop grid becomes one column without horizontal overflow at compact widths.
